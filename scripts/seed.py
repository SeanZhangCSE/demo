...
This script is intended for local development and demo purposes only. It uses
SQLModel metadata to ensure tables exist and then inserts sample rows. Running
this in production is not recommended.
"""
import asyncio
import os
